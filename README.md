*Capacitor*는 Ionic팀에 의해 2019년에 출시된 오픈 소스 플랫폼으로, 웹 애플리케이션을 네이티브 모바일 애플리케이션으로 변환하는데 사용됩니다. HTML, CSS, JavaScript 같은 웹 기술을 사용하며 네이티브 기능을 호출할 수 있고, ios와 Android 플랫폼을 지원합니다.
